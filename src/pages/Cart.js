...
export const Cart = () => {
	...
	const onClickClear = () => {
		if ( window.confirm( 'Do you realy want to delete all items?' ) ) {
			dispatch( clearItems() )
		}
	}
			...
			<div className="cart">
				...
				<div className="cart__bottom">
					<div className="cart__bottom-details">
						...
						<span> Total cost: <b>${ totalPrice }</b> </span>
					</div>
					<div className="cart__bottom-buttons">
						<Link to="/hot-pizza/" className="button button--outline button--add go-back-btn">
